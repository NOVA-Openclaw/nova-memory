...
ALTER FUNCTION public.calculate_word_count() OWNER TO nova;
...
ALTER FUNCTION public.insert_workflow_step(p_workflow_id integer, p_step_order integer, p_agent_name text, p_description text, p_produces_deliverable boolean, p_deliverable_type text, p_deliverable_description text) OWNER TO nova;
...
ALTER FUNCTION public.notify_agent_chat() OWNER TO nova;
...
ALTER FUNCTION public.notify_schema_change() OWNER TO nova;
...
ALTER FUNCTION public.protect_bootstrap_context_writes() OWNER TO nova;
...
ALTER FUNCTION public.update_work_status_on_publication() OWNER TO nova;
...
ALTER FUNCTION public.update_works_timestamp() OWNER TO nova;
...
ALTER TABLE public.publications OWNER TO nova;
...
ALTER SEQUENCE public.publications_id_seq OWNER TO nova;
...
ALTER TABLE public.shopping_history OWNER TO nova;
...
ALTER SEQUENCE public.shopping_history_id_seq OWNER TO nova;
...
ALTER TABLE public.shopping_preferences OWNER TO nova;
...
ALTER SEQUENCE public.shopping_preferences_id_seq OWNER TO nova;
...
ALTER TABLE public.shopping_wishlist OWNER TO nova;
...
ALTER SEQUENCE public.shopping_wishlist_id_seq OWNER TO nova;
...
ALTER TABLE public.tags OWNER TO nova;
...
ALTER SEQUENCE public.tags_id_seq OWNER TO nova;
...
ALTER TABLE public.work_tags OWNER TO nova;
...
ALTER TABLE public.works OWNER TO nova;
...
ALTER SEQUENCE public.works_id_seq OWNER TO nova;
...
ALTER PUBLICATION agent_chat_pub OWNER TO nova;
...
ALTER PUBLICATION graybeard_sync_pub OWNER TO nova;
...
ALTER EVENT TRIGGER schema_change_trigger OWNER TO nova;
